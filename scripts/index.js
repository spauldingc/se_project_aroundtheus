...
const cardImageModalPreview = document.querySelector("#card-image-modal-preview");
const cardImageModalTitle = document.querySelector("#card-image-modal-title");
const cardImageCloseBtn = document.querySelector("#card-image-modal-close-button");
